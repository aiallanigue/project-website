  ...
  return (
    <section className="py-16 bg-gray-100">
      <div className="container mx-auto px-4 text-center"  style={{ color: '#000' }}>
        ...
        <p className="text-lg mb-4 max-w-3xl mx-auto">
          At our core, we are a training and consulting company. We have the leadership, business coaching, consulting and training you need to learn how to build your business profitably.
        </p>
        <p className="text-lg max-w-3xl mx-auto">
          We are committed to being the place where entrepreneur&apos;s thrive.
        </p>
      </div>
    </section>
  );
