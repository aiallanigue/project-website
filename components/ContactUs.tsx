...
export default function ContactUs() {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-[40px] p-8 shadow-sm"  style={{ color: '#000' }}>
      <div className="text-center mb-8">
        <h2 className="text-3xl md:text-4xl font-serif font-bold">Contact Us</h2>
      </div>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2"  style={{ color: '#000' }}>
          <input
            type="text"
            name="firstName"
